...
export const domainPageCopy = {
  fr: {
    ...
    publicationsSubtitle: 'Sélection de travaux récents dans ce domaine (données de démonstration).',
    searchAll: 'Voir toutes les publications',
    backToCategories: 'Tous les domaines',
    emptyState: 'Aucune publication de démonstration pour ce domaine pour le moment.',
  ...
  en: {
    ...
    publicationsTitle: 'Publications',
    publicationsSubtitle: 'A selection of recent work in this field (demo data).',
    searchAll: 'View all publications',
    backToCategories: 'All fields',
    emptyState: 'No demo publications for this field yet.',
